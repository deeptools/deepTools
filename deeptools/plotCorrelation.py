...
scatter plots.; optionally, the values can be saved as tables, too.
...
def plot_correlation_args():
    ...
    required.add_argument('--corData', '-in',
                          metavar='FILE',
<<<<<<< HEAD
                          help='Correlation file generated by bigwigCorrelate or bamCorrelate',
=======
                          help='Correlation file generated by multiBigwigSummary or multiBamCoverage',
>>>>>>> 6c23b2312308805a7a7fafc6cf054b9b691eddb8
                          required=True)

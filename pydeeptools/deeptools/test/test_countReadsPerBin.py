...
class TestCountReadsPerBin:
    ...
    def test_count_reads_in_region(self, bc):
        c, _bamFile1, _bamFile2, _bamFile_PE, chrom, _step_size, _bin_length = self.ifiles(bc)
        c.skipZeros = False
    ...
    def test_count_reads_in_region_extension_1(self, bc):
        ...
        """
        c, bamFile1, bamFile2, _bamFile_PE, chrom, _step_size, _bin_length = self.ifiles(bc)
        c = cr.CountReadsPerBin(
            [bamFile1, bamFile2],
            binLength=1,
            stepSize=50,
    ...
    def test_get_coverage_of_region_sam_flag_include(self, bc):
        c, bamFile1, _bamFile2, _bamFile_PE, chrom, _step_size, _bin_length = self.ifiles(bc)
    ...
    def test_get_coverage_of_region_large_bin(self, bc):
        c, _bamFile1, bamFile2, _bamFile_PE, chrom, _step_size, _bin_length = self.ifiles(bc)
    ...
    def test_get_coverage_of_region_split_read(self, bc):
        ...
        """
        c, bamFile1, _bamFile2, _bamFile_PE, _chrom, _step_size, _bin_length = self.ifiles(bc)
    ...
    def test_bed_file(self, bc):
        c, _bamFile1, bamFile2, _bamFile_PE, _chrom, _step_size, _bin_length = self.ifiles(bc)
        bed = "chr3R\t0\t10\nchr3R\t110\t120\nchr3R\t160\t180"
        import tempfile
        with tempfile.NamedTemporaryFile(suffix=".bed", delete=False, mode="w") as bed_file:
            bed_file.write(bed)
